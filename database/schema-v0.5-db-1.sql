-- Sistema POS multisucursal - PostgreSQL schema v0.5-db-1
...
CREATE TABLE sales (
  ...
  CONSTRAINT fk_sales_cash_session_branch FOREIGN KEY (cash_session_id, branch_id) REFERENCES cash_sessions(id, branch_id),
...
ALTER TABLE quotations
  ADD CONSTRAINT fk_quotations_converted_sale FOREIGN KEY (converted_sale_id) REFERENCES sales(id);
...
CREATE TABLE replenishment_positions (
  ...
  CONSTRAINT ck_replenishment_positions_commit_not_over_demand CHECK (committed_qty_base <= demand_qty_base),
...
CREATE TABLE purchase_items (
  ...
  CONSTRAINT fk_purchase_items_order_item_product FOREIGN KEY (purchase_order_item_id, product_id) REFERENCES purchase_order_items(id, product_id),
