-- Sistema POS multisucursal - PostgreSQL schema v0.5-db-3
...
CREATE TABLE replenishment_allocations (
  ...
  CONSTRAINT ck_replenishment_allocations_fulfilled_purchase CHECK (fulfilled_qty_base = 0 OR purchase_item_id IS NOT NULL),
...
CREATE INDEX ix_replenishment_allocations_purchase_item ON replenishment_allocations (purchase_item_id);
